		...
		<div class="row">
			...
			<div class="col-lg-4">
				<ul class="img-ul">
					...
					<li>Работа с крупнейшими страховыми компаниями</li>
					<li>Современное оборудование и материалы передовых производителей</li>
					<li>Только сертифицированные запчасти</li>
					<li>Гарантия до 3 лет на кузовной ремонт</li>
				</ul>
			</div>
			<div class="col-lg-4">
				<div>
	...
	<div class="container">
		<div class="row">
			<div class="col-12">
				...
				<p class="fix-p">На нашем СТО всегда идеальная чистота.</p>
				<p class="fix-p">Самое современное оборудование.</p>
				<p class="fix-p">Прописанные для каждого сотрудника стандарты качества работ.</p>
			</div>
		</div>
